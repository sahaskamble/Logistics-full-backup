    ...
    <div className="max-w-container mx-auto px-6 py-10 space-y-8 bg-[color:var(--accent)] rounded-lg shadow-lg">
      ...
      */}
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <DetailCard label="Start Date" value={new Date(order.startDate).toLocaleDateString('en-US', { day: "2-digit", month: "long", year: "numeric" })} />
        <DetailCard label="End Date" value={new Date(order.endDate).toLocaleDateString('en-US', { day: "2-digit", month: "long", year: "numeric" })} />
